    ...
    def create_default_permissions(cls, tenant=None):
        ...
        role_permissions = {
            'student': {
                ...
                'academics': ['academics.view_course', 'academics.view_grade', 'academics.view_attendance'],
                'library': ['library.view_book', 'library.borrow_book'],
            },
            'parent': {
                'auth': ['auth.view_user', 'auth.change_user'],
                'academics': ['academics.view_child_grades', 'academics.view_child_attendance'],
            },
            'teacher': {
                'auth': ['auth.view_user', 'auth.change_user'],
                'academics': ['academics.view_course', 'academics.change_course', 'academics.view_grade', 
                             'academics.change_grade', 'academics.view_attendance', 'academics.change_attendance', 
                             'academics.view_student', 'academics.create_assignment', 'academics.grade_assignment'],
                'library': ['library.view_book', 'library.reserve_book'],
            },
            'accountant': {
                'auth': ['auth.view_user', 'auth.change_user'],
                'finance': ['finance.view_finance', 'finance.change_finance', 'finance.generate_invoice', 
                           'finance.process_payment', 'finance.view_financial_report'],
            },
            'librarian': {
                'auth': ['auth.view_user', 'auth.change_user'],
                'library': ['library.view_book', 'library.add_book', 'library.change_book', 'library.delete_book',
                           'library.manage_borrowings', 'library.view_members'],
            },
            'principal': {
                'auth': ['auth.view_user', 'auth.change_user'],
                'academics': ['academics.view_all_courses', 'academics.change_all_courses', 
                             'academics.view_all_grades', 'academics.view_all_attendance','academics.view_academics'],
                'staff': ['staff.view_staff', 'staff.change_staff', 'staff.evaluate_staff'],
                'finance': ['finance.view_finance', 'finance.approve_budget'],
                'reports': ['reports.view_all_reports', 'reports.generate_reports'],
            },
            'admin': {
                '*': ['*'],  # Admin gets all permissions (handled specially)
            },
            'super_admin': {
                '*': ['*'],
                'system': ['system.manage_tenants', 'system.manage_system_settings'],
            },
        }
