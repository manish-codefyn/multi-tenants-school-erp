...
class OnlineApplication(BaseModel):
    ...
    def save(self, *args, **kwargs):
        ...
        # Now generate application number with tenant
    ...
    #         # Eligibility check (only if we have date_of_birth)
    #         if self.status != "DRAFT" and self.program and not self.is_eligible:
    #             errors['date_of_birth'] = _("Does not meet age eligibility criteria for this class")
    #     else:
    #         # Date of birth is required
    #         if self.status != "DRAFT":
    #             errors['date_of_birth'] = _("Date of birth is required")
        
    #     # Email uniqueness in same admission cycle
    #     if self.email and self.admission_cycle:
