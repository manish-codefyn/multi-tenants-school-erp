...
class StudentForm(SecureStudentForm):
    ...
    class Meta:
        model = Student
        exclude = [
            'tenant', 'created_by', 'updated_by', 'deleted_by', 'user','status_changed_date','graduation_date',
        ...
        widgets = {
            ...
            # ),
            # 'status_changed_date': forms.DateTimeInput(
            ...
            'description': forms.Textarea(
                attrs={
                    'placeholder': _('Additional information about the student'),
                    'class': 'form-control',
                    'rows': 3
                }
            ),
            'annual_family_income': forms.NumberInput(
                attrs={
                    'placeholder': _('Annual family income in INR'),
                    'class': 'form-control',
                    'min': 0,
                    'step': 1000
                }
    ...
    class Meta:
        ...
        widgets = {
            ...
            'occupation': forms.TextInput(attrs={
                'placeholder': _('Occupation/profession'),
                'class': 'form-control'
            }),
